...
public class BottomBar extends View {
    ...
    public BottomBar setTitleBeforeAndAfterColor(int beforeResCode, int AfterResCode){
        titleColorBefore = ContextCompat.getColor(context, beforeResCode);
        titleColorAfter = ContextCompat.getColor(context, AfterResCode);
        return this;
    }
